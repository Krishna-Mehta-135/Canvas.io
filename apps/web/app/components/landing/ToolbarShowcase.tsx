        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 dark:text-white/60 mb-8 leading-relaxed">
              ...
              <kbd className="px-2 py-0.5 bg-gray-200 dark:bg-white/10 border border-gray-300 dark:border-white/10 rounded text-sm font-mono">
                0
              </kbd>
              –
              <kbd className="px-2 py-0.5 bg-gray-200 dark:bg-white/10 border border-gray-300 dark:border-white/10 rounded text-sm font-mono">
...
function ToolButton({
  ...
  return (
    ...
    >
      ...
      <span
        className={`text-[10px] font-mono leading-none ${active ? "text-indigo-500 dark:text-indigo-400" : "text-gray-400 dark:text-white/30"}`}
      >
        {tool.shortcut}
      </span>
    ...
    return (
      <div className="relative">
        ...
        {[
          ...
          <div
            key={i}
            className="absolute w-2 h-2 bg-indigo-500 rounded-sm"
            style={{ left: x, top: y }}
          />
        ))}
      </div>
