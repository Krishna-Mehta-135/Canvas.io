...
export default function ForgotPasswordPage() {
    ...
    const getSubmitErrorMessage = (submitError: unknown) => {
        if (typeof submitError === "object" && submitError !== null && "response" in submitError) {
            const response = submitError.response as {data?: {message?: string}} | undefined;
    ...
    return (
        ...
        >
            ...
            >
                ...
                <p className="mt-1 text-sm opacity-75">Request password reset instructions</p>

                <form onSubmit={handleSubmit} className="mt-5 space-y-3">
                    <label className="block text-xs font-semibold opacity-75" htmlFor="forgot-email">
                        Email address
                    </label>
                    <input
                        id="forgot-email"
                ...
                {submitted && (
                    ...
                    >
                        If an account exists for this email, reset instructions will be sent. Check your inbox and spam folder.
                    </div>
                )}
