...
export declare function getRoomSnapshot(
  roomId: number,
): Promise<RoomSyncState | null>;
export declare function setRoomSnapshot(
  roomId: number,
  snapshot: Shape[],
  version: number,
): Promise<void>;
export declare function publishRoomEvent(
  roomId: number,
  event: Omit<RedisRoomEvent, "roomId">,
): Promise<void>;
export declare function commitRoomSnapshot(
  roomId: number,
  expectedVersion: number,
  snapshot: Shape[],
  event: Pick<RedisRoomEvent, "originNodeId" | "senderId" | "actionId">,
): Promise<number | null>;
export declare function subscribeRoomEvents(
  handler: (event: RedisRoomEvent) => void | Promise<void>,
): Promise<void>;
export declare function checkRedisRateLimit(
  routeKey: string,
  limit: number,
  windowMs: number,
